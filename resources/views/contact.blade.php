        ...
        <div class="max-w-screen-md mx-auto p-5 mt-[150px]">
            <div class="text-center mb-2">
                ...
                <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
                    Rellenando <span class="text-indigo-600">El Formulario</span>
                </h3>
            </div>
            ...
            <form class="w-full">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <p class="text-red-500 text-xs italic">El campos es requerido.</p>
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input
                            ...
                            id="grid-last-name" type="text" placeholder="Apellidos">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
